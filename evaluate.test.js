...
test("evaluate countSTRINGLENGTH", () => {
  // Test with a string containing STRINGLENGTH token
  expect(evaluate("count{STRINGLENGTH[InputText]}")).toBe("count9");

});

test("evaluate countSTRINGLENGTHstringOnEnd", () => {
  // Test with a string containing STRINGLENGTH token
  expect(evaluate("count{STRINGLENGTH[InputText]}stringOnEnd")).toBe("count9stringOnEnd");
